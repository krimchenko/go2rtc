...
func handlerWSMSE(tr *ws.Transport, msg *ws.Message) error {
	...
	tr.OnClose(func() {
		...
		app.RecordEvent(time.Now(), "webrtc-stop", srcName, tr.Request.RemoteAddr, app.GetAuthToken(tr.Request))
	})

	app.RecordEvent(time.Now(), "webrtc-start", srcName, tr.Request.RemoteAddr, app.GetAuthToken(tr.Request))
